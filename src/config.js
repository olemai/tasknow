...
const bookingProcessAlias = 'Task booking/release-1';

// The transaction line item code for the main unit type in bookings.
//
// Possible values: ['line-item/Task', 'line-item/units';]
//
// Note: translations will use different translation keys for night, day or unit
// depending on the value chosen.
const bookingUnitType = 'line-item/Task';
...
const addressRegion = 'Berlin';
const postalCode = '10625';
const streetAddress = 'Goethestraße 70';

// Canonical root url is needed in social media sharing and SEO optimization purposes.
const canonicalRootURL = process.env.REACT_APP_CANONICAL_ROOT_URL;

// Site title is needed in meta tags (bots and social media sharing reads those)
const siteTitle = 'TASKNOW';
